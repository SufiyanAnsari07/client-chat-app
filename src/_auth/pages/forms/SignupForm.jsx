...
const SignupForm = () => {
  ...
  return (
    <div className='flex-center flex-col gap-2 w-full mt-20 relative h-full'>
      {error && (
        <p className="absolute px-2 py-3 top-3 w-full text-center text-lg bg-red-500 font-bold rounded-md">
          {error}
        </p>
      )}
      ...
      <form onSubmit={handleSubmit(signup)} className='flex flex-col w-[90%] lg:w-[80%] gap-5'>
        ...
        <div className='flex flex-col gap-2 justify-center'>
          ...
          <input
            ...
            className='bg-slate-700 font-medium outline-none text-white px-3 rounded-lg py-2 xl:px-4 xl:py-3 w-full shadow shadow-slate-600 focus:border focus:border-slate-600'
          />
        ...
        <div className='flex flex-col gap-2 justify-center'>
          ...
          <input 
            ...
            className='bg-slate-700 font-medium outline-none text-white xl:px-4 xl:py-3 px-3 rounded-lg py-2 w-full shadow shadow-slate-600 focus:border focus:border-slate-600'
          />
        ...
        <div className='flex flex-col gap-2 justify-center'>
          ...
          <div className="w-full relative">
            <input 
              ...
              className='bg-slate-700 xl:px-4 xl:py-3 font-medium outline-none text-white px-3 rounded-lg py-2 w-full shadow shadow-slate-600 focus:border focus:border-slate-600'
            />
          ...
          <div className="w-full flex justify-center items-center">
            {imagePreview ? (
              ...
              <button
                ...
                type="button"
                className="bg-blue-500 px-4 cursor-pointer py-3 capitalize rounded-md font-bold w-50"
              >
                upload
              </button>
            )}
        ...
        <div className="w-full flex flex-col gap-3 justify-center">
          ...
          <Link to={"/login"} className="text-blue-500 w-fit hover:underline">
